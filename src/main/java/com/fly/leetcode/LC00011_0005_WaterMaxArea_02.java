 ...
 **/
public class LC00011_0005_WaterMaxArea_02 {
    public static void main(String[] args) {
        System.out.println(new LC00011_0005_WaterMaxArea_02().maxArea(new int[]{1, 8, 6, 2, 5, 4, 8, 3, 7}));
    }
