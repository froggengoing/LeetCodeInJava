 ...
 **/
public class LC00045_JumpGame2_01 {
    public static void main(String[] args) {
        ...
        System.out.println(new LC00045_JumpGame2_01().jump(new int[]{0,0}));
        System.out.println(new LC00045_JumpGame2_01().jump(new int[]{1,0,0}));
